...
public class Persona {
	...
	@OneToMany(cascade = CascadeType.REFRESH, fetch = FetchType.EAGER, mappedBy = "prestatario")
	...
	public void setLibros(List<Copia> libros) {
		this.librosPrestados = libros;
	}
	
	public void addLibro(Copia copia) {
		librosPrestados.add(copia);
		copia.setOwner(this);
	}
	
	public void removeLibro(Copia copia) {
		librosPrestados.remove(copia);
		copia.setOwner(null);
	}
